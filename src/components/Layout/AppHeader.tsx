...
export function AppHeader() {
  ...
  return <header className="bg-gradient-header border-b border-white/20 shadow-medium">
      <div className="flex items-center justify-between min-h-20 px-6 sm:px-8 py-4 gap-2 sm:gap-4">
        ...
        <div className="flex items-start gap-2 sm:gap-3 flex-shrink-0">
          ...
          <div className="grid grid-cols-2 sm:flex gap-1 sm:gap-2">
            ...
            <Button variant="ghost" size="sm" onClick={handleLogout} className="col-span-2 sm:col-span-1 text-white hover:text-white hover:bg-white/20 border border-white/30 rounded-lg px-2 sm:px-3 h-8 sm:h-9 text-xs sm:text-sm">
