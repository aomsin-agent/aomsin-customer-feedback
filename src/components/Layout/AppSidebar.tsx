...
export function AppSidebar() {
  ...
  return (
    <>
      ...
      <div className="hidden lg:flex fixed left-0 w-16 bg-gray-50/95 backdrop-blur-sm border-r border-gray-200 flex-col items-center py-4 -z-10" style={{ top: 'max(5rem, calc(5rem + 1vh))', bottom: 'max(4rem, calc(4rem + 1vh))' }}>
